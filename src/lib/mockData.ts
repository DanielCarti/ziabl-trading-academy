...
export const mockGlossaryTerms = [
  ...
  { id: 'g-b-1', termRu: 'ОФЗ-ПД', termEn: 'OFZ-PD (Fixed)', definitionRu: 'Облигации федерального займа с постоянным купоном на весь срок обращения', definitionEn: 'Federal loan bonds with fixed coupon payments', category: 'Облигации', relatedLessonSlug: 'what-are-bonds' },
